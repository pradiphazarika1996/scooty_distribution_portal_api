...
// // ── Column definitions — single source of truth for both formats ───────────
...
// // PDF column widths in points (landscape A4 usable ≈ 780pt)
...
// // ── Row builder — shared between Excel and PDF ─────────────
...
//       Object.fromEntries(COLUMNS.map((col, i) => [col.key, values[i]])),
//     );
//     row.height = 18;
...
//     .fontSize(13)
//     .fillColor("#1e293b")
//     .text("MAC Scholarship Portal — Applications", 30, 30)
//     .font("Helvetica")
//     .fontSize(8)
//     .fillColor("#64748b")
//     .text(`Exported on ${today}  ·  ${applications.length} records`, 30, 48);
...
//   const PAGE_BOTTOM = (doc.page.height as number) - 30;

//   let y = 65; // below title
